...
predictor = dlib.shape_predictor(
    "D:\Stress_Detector-master\Stress_Detector-master\code\shape_predictor_68_face_landmarks.dat")
# loading the trained model
emotion_classifier = load_model(
    "D:\Stress_Detector-master\Stress_Detector-master\code\_mini_XCEPTION.102-0.66.hdf5", compile=False)
...
def lpdist(l_lower, l_upper):
    l_lower = l_lower[0]  # Extract the 1D vector from l_lower
    l_upper = l_upper[0]  # Extract the 1D vector from l_upper
